...
-- turn off macro reording and others
vim.cmd([[
map q <Nop>
map s <Nop>
map m <Nop>
...
map("n", "<leader>we", "<C-w>k")
map("n", "<leader>wi", "<C-w>l")
-- split the screens to up (horizontal), down (horizontal), left (vertical), right (vertical)
map("n", "<leader>se", ":set nosplitbelow<CR>:split<CR>:set splitbelow<CR>")
map("n", "<leader>sn", ":set splitbelow<CR>:split<CR>")
map("n", "<leader>sh", ":set nosplitright<CR>:vsplit<CR>:set splitright<CR>")
map("n", "<leader>si", ":set splitright<CR>:vsplit<CR>")
...
map("n", "<leader>tu", ":tabe<CR>")
map("n", "<leader>tU", ":tab split<CR>")
-- Move around tabs with tn and te
map("n", "<leader>tn", ":-tabnext<CR>")
map("n", "<leader>te", ":+tabnext<CR>")
-- Move the tabs with th and ti
map("n", "<leader>th", ":-tabmove<CR>")
map("n", "<leader>ti", ":+tabmove<CR>")
...
-- Navigate buffers
map('n', '<leader>be', ':bprevious<CR>', {})
map('n', '<leader>bn', ':bnext<CR>', {})
map('n', '<leader>bh', ':bfirst<CR>', {})
map('n', '<leader>bi', ':blast<CR>', {})
